...
#define DELTA_SMOOTH_ROD_OFFSET 175.7 // mm //158

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 19 // mm 
...
#define Z_PROBE_OFFSET {-23.3, 2, -6.3, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
//X:-42.00Y:-96.50Z:28.83
#define Z_PROBE_DEPLOY_START_LOCATION {-50, -83.5, 20, 0}   // X, Y, Z, E start location for z-probe deployment sequence
#define Z_PROBE_DEPLOY_END_LOCATION {-33, -105, 20, 0}  // X, Y, Z, E end location for z-probe deployment sequence
#define Z_PROBE_RETRACT_START_LOCATION {-56, -98, 71.83, 0}  // X, Y, Z, E start location for z-probe retract sequence
#define Z_PROBE_RETRACT_END_LOCATION {-56, -98, 56.83, 0}    // X, Y, Z, E end location for z-probe retract sequence 
...
#define MANUAL_Z_HOME_POS 408.6  // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 142.5 * 45.0/11.0}
